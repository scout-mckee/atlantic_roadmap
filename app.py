...
def render_tab(tab, categories, subcategories, locations, stakeholders):
    ...
    if tab == "initiatives":
        return dag.AgGrid(
            ...
            columnDefs=[
                ...
                {"headerName": "Expected Timeline", "field": "Expected Timeline", "width": 130},
            ],
    ...
    return dag.AgGrid(
        className="ag-theme-alpine",
        columnDefs=[
            {"headerName": "Initiative", "field": "Initiative", "autoHeight": True, "minWidth": 260, "flex": 1},
            {"headerName": "Category", "field": "Category", "width": 140},
            {"headerName": "NB", "field": "NB Status", "width": 85, "cellStyle": status_style},
            {"headerName": "NS", "field": "NS Status", "width": 85, "cellStyle": status_style},
            {"headerName": "PEI", "field": "PEI Status", "width": 85, "cellStyle": status_style},
            {"headerName": "NL", "field": "NL Status", "width": 85, "cellStyle": status_style},
            {"headerName": "Regional", "field": "Regional", "width": 110, "cellStyle": status_style},
            {"headerName": "Metric Notes", "field": "Metric Notes", "autoHeight": True, "minWidth": 220, "flex": 1},
        ],
